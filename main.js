(() => {
  ...
  /* reveal-line spans animate via CSS transform on visible */
  const style = document.createElement('style');
  style.textContent = `.reveal-line.is-visible > span{transform:translateY(0);transition:transform .9s cubic-bezier(.16,1,.3,1);}`;
